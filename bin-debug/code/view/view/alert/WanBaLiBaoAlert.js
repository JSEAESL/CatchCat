...
(function (mx) {
    var WanBaLiBaoAlert = (function (_super) {
        ...
        WanBaLiBaoAlert.mx_support = function () {
            return ["assets.wanba", "api.EQUIP", "api.WANBALIBAO"];
        };
        ...
        WanBaLiBaoAlert.prototype.init_pop = function () {
            ...
            if (data.state == 1) {
                ...
                zg.y = 70;
                view.content_t.text = mx.Lang.wblb01;
                ...
                view.content_t.text = mx.Lang.wblb02;
                view.background.source = "wblbylqdban_png";
                this.jl_g.top = 62;
            }
            else if (cid == 100) {
                view.background.source = "lqsbdban_png";
                view.content_t.text = mx.Lang.wblb04;
            }
            else {
                view.background.source = "lqsbdban_png";
                view.content_t.text = mx.Lang.wblb03[data.state - 2000] || "";
                this.tip_p.visible = false;
