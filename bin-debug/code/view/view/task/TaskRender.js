...
(function (mx) {
    var TaskRender = (function (_super) {
        ...
        TaskRender.prototype.do_main_task = function () {
            var cd = this.data;
            var facade = mx.ApplicationFacade.getInstance();
        ...
        TaskRender.prototype.do_day_task = function () {
            var cd = this.data;
            var facade = mx.ApplicationFacade.getInstance();
            var gProxy = facade.retrieveProxy(mx.GameProxy.NAME);
        ...
        TaskRender.prototype.fresh_main = function () {
            var info = this.data;
            var str = "{0" + mx.Lang.t0000 + "0}" + info.describe;
            this.desc_t.textFlow = mx.Tools.setKeywordColor2(str, [0xffffff]);
            var flow = [];
            var num = 1;
        ...
        TaskRender.prototype.fresh_day = function () {
            var info = this.data;
    ...
    mx.TaskRender = TaskRender;
    __reflect(TaskRender.prototype, "mx.TaskRender");
})(mx || (mx = {}));
