...
(function (mx) {
    var StartScreen = (function (_super) {
        ...
        StartScreen.mx_support = function () {
            return ["assets.start", "assets.public", "api.GUIDEINFO", "api.PNAME"];
        };
        //注销自身，必须实现
            ...
            switch (evt.currentTarget) {
                ...
                case view.start_b://点击开始判断是否维护
                    ...
                    if (c_info) {
                        ...
                        if (Main.WX_USER_INFO) {
                            facade.sendNotification(mx.MX_NOTICE.CS_GET_DATA, { "t": mx.MX_NETS.CS_USER_INFO, "user_info": Main.WX_USER_INFO });
                        }
                        else {
