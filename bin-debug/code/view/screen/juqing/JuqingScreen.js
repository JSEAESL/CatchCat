...
(function (mx) {
    var JuqingScreen = (function (_super) {
        ...
        JuqingScreen.prototype.unlock_chapter = function () {
            ...
            egret.Tween.get(view.name_g).to({ 'scaleX': 1, 'scaleY': 1, 'horizontalCenter': 0, 'verticalCenter': 0 }, 5 * mx.FightView.FLASH_DESC).call(function () {
                var new_ef = new mx.GeneralEffect("zjkqdhua");
                new_ef.name = "zjkqdhua";
                new_ef.play_by_times(1);
                new_ef.set_retain(true);
                new_ef.verticalCenter = -340;
                ...
                view.name_g.scaleX = view.name_g.scaleY = 0;
                view.name_g.alpha = 1;
                view.name_g.visible = false;
